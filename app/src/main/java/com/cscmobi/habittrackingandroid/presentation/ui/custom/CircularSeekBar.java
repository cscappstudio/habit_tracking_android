...
import static com.cscmobi.habittrackingandroid.presentation.ui.custom.Utils.removeAlpha;
...
public class CircularSeekBar extends View {
    ...
    private void initAttributes(AttributeSet attributeSet) {
        if (attributeSet != null) {
            ...
            mTextColor = typedArray.getColor(R.styleable.CircularSeekBar_cs_text_color, ContextCompat.getColor(getContext(), R.color.black));
    ...
    private void init() {
        indicatorDrawable = getYourDrawable(); // Replace with your actual drawable
...
//        mIndicatorPaint.setAntiAlias(true);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int drawableWidth = indicatorDrawable.getIntrinsicWidth();
        int drawableHeight = indicatorDrawable.getIntrinsicHeight();

        // Adjust the drawable position based on its size
        indicatorDrawable.setBounds(
                (int) (mTranslateX - mIndicatorIconX - drawableWidth / 4 -35),
                (int) (mTranslateY - mIndicatorIconY - drawableHeight / 4),
                (int) (mTranslateX - mIndicatorIconX + drawableWidth / 4 -35),
                (int) (mTranslateY - mIndicatorIconY + drawableHeight / 4)
        );
    ...
    // Replace this with your actual drawable retrieval logic
    private Drawable getYourDrawable() {
        return ContextCompat.getDrawable(getContext(), R.drawable.ic_thumbseekbar_goal);
    }
