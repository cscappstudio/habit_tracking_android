...
import com.cscmobi.habittrackingandroid.thanhlv.ui.YearCalendarFragment

class PagerYearCalendarAdapter(fragmentActivity: FragmentActivity) :
    ...
    override fun createFragment(position: Int): Fragment {
        ...
        return YearCalendarFragment.newInstance(monthYearModel.year)
    }
}