package com.cscmobi.habittrackingandroid.thanhlv.consent
    ...
    fun gatherConsent(
        ...
        val debugSettings =
            ConsentDebugSettings.Builder(activity)
                ...
                .addTestDeviceHashedId("AB7882CCB0B48C39D2B02A6718C9BF50")
                .build()

        val params = if (BuildConfig.DEBUG) ConsentRequestParameters.Builder()
